...
export default function CustomerDetails({ navigation, route }) {
  ...
  const handleAddToForm = () => {
    ...
    let responseData = {
      ...
      discount_price: discountDetails?.value ? discountDetails?.value : 0,
      status: "Completed",
  ...
  const submitUser = async (responseData) => {
    try {
      ...
      if (res?.status === 200) {
        console.log("orderrrrr resssss", res?.data);
  ...
  const generatePdf = async () => {
    ...
    try {
      ...
      console.log("resssssss of pdf",res);
      if (res?.status === 200) {
        console.log("resssssss of pdf",res?.data);
  ...
  const openWhatsApp = (data) => {
    console.log("data in the open whatsapp",data);
    setLoading(false);
          ...
          <View style={myStyle.contentContainer}>
                  ...
                  return (
                    <View style={myStyle.dropdownButtonStyle}>
                      ...
                      {/* <Icon
                        ...
                        style={myStyle.dropdownButtonArrowStyle}
                      /> */}
                    </View>
                  );
                }}
            ...
            <View style={myStyle.footer}>
              <Text style={myStyle.noteText}>
                Note: Delivery charges will apply. By default, charges are 200
                but may change according to location.
              </Text>
